...
<head>
    <meta charset="UTF-8">
    <title>depart add</title>
    <link rel="stylesheet" href="../../css/style.css">
    <link rel="stylesheet" href="../../css/reset.css">
    <script src="../../js/jquery-1.8.3.min.js"></script>
    <script src="../../js/adminRecordAdd.js"></script>
</head>
<body>
...
<div class="container">
    ...
    <div class="right-content">
        <div class="add-table">
            <form action="${pageContext.request.contextPath}/jsp/admin/record.do" id="addForm" name="addForm"
                  method="post">
                ...
                <div>
                    <label>迟到次数</label>
                    <input type="text" name="lateRecord" id="lateRecord" value="">
                </div>
                <div>
                    <label>销售提成</label>
                    <input type="text" name="saleBonus" id="saleBonus" value="">
                </div>
                <div>
                    <label>加班次数</label>
                    <input type="text" name="overtimeRecord" id="overtimeRecord" value="">
                </div>
                <div>
                    <label>节日加班奖金</label>
                    <input type="text" name="festivalBenifit" id="festivalBenifit" value="">
                </div>
                <div>
                    <label>年终奖</label>
                    <input type="text" name="yearBonus" id="yearBonus" value="">
                </div>
                <div>
                    <label>旷工次数</label>
                    <input type="text" name="absentRecord" id="absentRecord" value="">
                </div>
                <div>
                    <label>福利奖金</label>
                    <input type="text" name="benifit" id="benifit" value="">
                </div>
                <div class="add-btn">
