...
public class HrEmployeeServlet extends HttpServlet {
    ...
    private void ban(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (flag) {
            resp.sendRedirect(req.getContextPath() + "/jsp/hr/employee.do?method=query");
        }
    }
    ...
    private void view(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/jsp/hr/employeeView.jsp").forward(req, resp);
    }
    ...
    private void query(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/jsp/hr/HrEmployeeList.jsp").forward(req, resp);
    }
}
