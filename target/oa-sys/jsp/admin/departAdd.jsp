...
<head>
    ...
    <script src="../../js/adminDepartAdd.js"></script>
</head>
<body>
...
<div class="container">
    ...
    <div class="right-content">
        <div class="add-table">
            <form action="${pageContext.request.contextPath}/jsp/admin/depart.do" id="addForm" name="addForm"
                  method="post">
                <input type="hidden" name="method" value="add">
                <div>
                    <label>部门编号</label>
                    <input type="text" name="departId" id="departId" value="">
                </div>
                <div>
                    <label>部门名称</label>
